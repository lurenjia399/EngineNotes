...
> 这个标志位的意思就是当前这个Bunch里面是否包含ExportNetGUID。服务器在构建发送Bunch的时候会序列化Object，在序列化的时候如果Object是网络稳定的，就会将Object的NetGUID额外写到ExportBunch里面，在SendBunch方法里面会将ExportBunch部分放到主体Bunch之前发往客户端，客户端
