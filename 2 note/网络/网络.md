...
有几个小问题：
1 客户端上的本地权威Actor，其参与了属性同步并有所属链接就能远端执行。意思是我客户端创建一个Actor，其bReplicated为true，并把它的owner设置为playercontroller，他就能执行RPC了么？
2 客户端上的非本地权威Actor，那就有两种吧一种autonomous一种是simluated的，auto的常规，但是对于simluated的，如果把它的owner设置为playercontroller，他也能执行RPC的么？
# 问题：
