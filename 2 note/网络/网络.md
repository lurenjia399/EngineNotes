...
> 对于静态的SubObject，以为SubObject本身就是在磁盘中的，我们只需要LoadObject就行，但是如果开启了异步加载，客户端就无法立刻求解出Object。对于这种情况，服务器会在InternalWriteObject方法中，将NetGUID添加到MustBeMappedGuidsInLastBunch这个Bunch里面，并最终放在ExportBunch的后边一起发往客户端，客户端会在ReceivedRawBunch里注册和求解NetGUID，然后在ReceivedBunch里面将MustbeMappedBunch内容tian'jia
