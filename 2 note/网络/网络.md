...
注意这里面会走到Object的GetLifetimeReplicatedProps方法，来获取同步属性的同步条件。
...
```
就是创建RepChangedPropertyTracker，通过UClass找到需要同步的属性，然后会调用UObject的GetReplicatedCustomConditionState这个方法，这个方法
