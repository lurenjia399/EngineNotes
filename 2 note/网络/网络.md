...
4 我们在SendBunch的时候，会执行AppendExportBunches方法，这个方法作用就是遍历ExportBunches数组，将其内容放到SendBunch里的要发送的Bunch中（在3中说的CurrentExportBunch满了ExportBunches才会有值，如果CurrentExportBunch没满，这一次SenBunch就不会）。
*/
