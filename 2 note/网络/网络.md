...
好像有两个种情况，第一种情况是路径稳定的Object，客户端会在硬盘中找对应的Object，然后加载，如果开启了异步加载就无法立即求解出了。第二情况是动态的Object，客户端在收到NetGUID的时候，可能服务器还没同步过来，客户但还没创建，这样也无法立即求解出。为了解决这两种情况，就有了对应的延迟求解机制，对于第一种情况开启了异步加载，服务器在序列化Object的时候会将NetGUID放入到MustBeMappedBunch里面，然后放入到exportBunch后边一起发往客户端，客户端收到Bunch如果有路径稳定的Object没加载出来，就会把Bunch放入到QueueBunch里面，等待TickFlush里对QueueBunch的处理。杜宇di'er'zhon
