...
- 服务器客户端是怎么同步的呢？
在服务器上，主要通过NetDriver::TickFlush方法来开始，会调用到ServerReplicataActors方法，这个方法里面首先通过ServerReplicateActors_PrepConnections方法确定有几个ClientConnection可以同步，然后会在ServerReplicateActors_BuildConsiderList这个方法中构建可同步的ActorList，之后会在ServerReplicateActors_PrioritizeActors这个方法中对可同步
