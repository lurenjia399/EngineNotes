...
bool FObjectReplicator::ReplicateProperties(...)
{
	...
	// 参数4 ： 记录的帧数，上一次属性改变，需要同步的帧数
	// 参数5 ： FReplicationFlags结构体，是个union
	// 参数6 ： 是否强制比较属性，这里是false。bForceCompareProperties这个值可以在AActor::ForcePropertyCompare方法里设置
