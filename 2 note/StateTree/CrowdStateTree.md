...
2 FMassZoneGraphLaneLocationFragment这个被添加到Entity后，UMassZoneGraphLocationInitializer这个ObserverProcrssor就会被触发，执行execute方法，方法中的内容是以entity的transform为中心，配置为半径，按照FindNearestLane