...
2 如果entity添加了这个Fragment，首先会找FMassZoneGraphLaneLocationFragment这个，来确定entity是在na就会从ZoneGraphAnnotationSubSystem的AnnotationTagContainer变量中获取所在Lane的Tag，设置到Fragment中
```
