...
2 进入之后，会执行FMassCrowdClaimWaitSlotTask，这里面会更新WaitArea的数量，如果等待的人太过了满了，就会改变LaneTag为Closedlane，退出WaitatIntersection，重新Wander，也就是重新找漫游d
```
# 5 征用
