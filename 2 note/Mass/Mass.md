...
//**************以上7个都在FMassArchetypeData::ConfigureFragments方法中实现***********
	8 TArray<FInstancedStruct> ChunkFragmentsTemplate;//这个就是ChunkFragments里的数据，经过排序后，会将ChunkFragments里面按照Gragment
*/
