...
2 执行UMassCrowdUpdateISMVertexAnimationProcessor::UpdateISMVertexAnimation方法，将entity的动画数据记录到ISMDesc的CustomData中，等待RepresentationSubsystem中执行SetCustomDataById，把数据根据InstanceID记录到ISMComp里
3 
```
