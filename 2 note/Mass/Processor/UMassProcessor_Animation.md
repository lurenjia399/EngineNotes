...
2 执行UMassCrowdUpdateISMVertexAnimationProcessor::UpdateISMVertexAnimation方法，将entity的动画数据记录到ISMDesc的Customdata，等待RepresentationSubsystem中执行SetCustomDataById，把
```
