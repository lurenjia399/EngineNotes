...
2 根据AnimStateIndex从AnimToTexture资源中选择AnimSequence，以及动画播放的开始时间，播放速率，把这些数据组装成FMassCrowdAnimInstanceData，记录到AnimInstance。如果是从ISM切换成Actor的就立刻TickAnimation和RefreshBoneTransforms
3 在AnimInstance更新数据的时候
```
