...
- 流式关卡是怎么切换的？
> StreamingLevel的触发有三种情况，使用streamingVolume的形式：这个就是在场景中布置Volume，然后判断playerController的viewtarget和Volume的距离，如果在Volume中就改变三个标志位，ShouldBeVisible，ShouldBeLoaded，ShouldBeBlockOnLoad。使用WoldComposition
